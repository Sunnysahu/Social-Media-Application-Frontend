...
function PostComponent({ images }) {
  ...
  return (
    <div className="px-[2vw] mb-4 flex flex-col items-start lg:items-center">
  <div
    className="w-full max-w-xl p-2 bg-gray-100 lg:w-[35vw] lg:border-2 rounded-lg"
    style={{ boxShadow: "0 -4px 10px rgba(0, 0, 0, 0.5)" }}
  >
    {/* Top Section */}
    <div className="flex justify-between items-start">
      {/* Left Block: Username + Song + Date + Location */}
      <div className="flex items-end gap-[4vw] w-full">
